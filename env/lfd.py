"""
This is the environment file for LFD.
- Intelligent AIOps Log Analysis: log fault diagnosis.
[Ref] https://tianchi.aliyun.com/competition/entrance/531947
"""
import json
from .base import Env
from .prompts.lfd_prompt import ZERO_SHOT_PROMPT, CASE_PROMPT, CBR_PROMPT, CASE_PROMPT_REFLEXION
...
class LFDEnv(Env):
    ...
    def init_env(self):
        with open("data/lfd/lfd.jsonl", encoding="utf-8") as file:
            for line in file:
