"""
This is the environment file for ALFWorld, specifically adapted to ReAct.
...
from .prompts.alfworld_react_prompt import *
import textworld
from alfworld.agents.environment.alfred_tw_env import AlfredDemangler, AlfredInfos
from textworld.gym.envs import TextworldGymEnv

class ALFWorldReActEnv(SeqEnv):
    ...
    def init_env(self):
        ...
        env = TextworldGymEnv(game_files, request_infos, max_episode_steps=30+5, wrappers=wrappers)
    ...
    def interact(self, generated_text):
        ...
        if not generated_text.startswith("[Action]"):
            ...
            elif action not in self.action_list:
                obs, reward, stop, infos = self.alfworld_env.step("look")
