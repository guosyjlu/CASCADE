"""
This is the environment file for RCA.
- Intelligent Log Analysis: root cause analysis.
[Ref] LogReasoner: Empowering LLMs with Expert-like Coarse-to-Fine Reasoning for Log Analysis Tasks
"""
import json
from .base import Env
from .prompts.rca_prompt import ZERO_SHOT_PROMPT, CASE_PROMPT, CBR_PROMPT, CASE_PROMPT_REFLEXION
...
class RCAEnv(Env):
    ...
    def init_env(self):
        with open("data/rca/rca.jsonl", encoding="utf-8") as file:
            for line in file:
