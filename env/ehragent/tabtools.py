...
def db_loader(target_ehr):
    ehr_dict = {"admissions":"<CASCADE_DIR_PATH>/data/mimic-iii/source/ADMISSIONS.csv",
                "chartevents":"<CASCADE_DIR_PATH>/data/mimic-iii/source/CHARTEVENTS.csv",
                "cost":"<CASCADE_DIR_PATH>/data/mimic-iii/source/COST.csv",
                "d_icd_diagnoses":"<CASCADE_DIR_PATH>/data/mimic-iii/source/D_ICD_DIAGNOSES.csv",
                "d_icd_procedures":"<CASCADE_DIR_PATH>/data/mimic-iii/source/D_ICD_PROCEDURES.csv",
                "d_items":"<CASCADE_DIR_PATH>/data/mimic-iii/source/D_ITEMS.csv",
                "d_labitems":"<CASCADE_DIR_PATH>/data/mimic-iii/source/D_LABITEMS.csv",
                "diagnoses_icd":"<CASCADE_DIR_PATH>/data/mimic-iii/source/DIAGNOSES_ICD.csv",
                "icustays":"<CASCADE_DIR_PATH>/data/mimic-iii/source/ICUSTAYS.csv",
                "inputevents_cv":"<CASCADE_DIR_PATH>/data/mimic-iii/source/INPUTEVENTS_CV.csv",
                "labevents":"<CASCADE_DIR_PATH>/data/mimic-iii/source/LABEVENTS.csv",
                "microbiologyevents":"<CASCADE_DIR_PATH>/data/mimic-iii/source/MICROBIOLOGYEVENTS.csv",
                "outputevents":"<CASCADE_DIR_PATH>/data/mimic-iii/source/OUTPUTEVENTS.csv",
                "patients":"<CASCADE_DIR_PATH>/data/mimic-iii/source/PATIENTS.csv",
                "prescriptions":"<CASCADE_DIR_PATH>/data/mimic-iii/source/PRESCRIPTIONS.csv",
                "procedures_icd":"<CASCADE_DIR_PATH>/data/mimic-iii/source/PROCEDURES_ICD.csv",
                "transfers":"<CASCADE_DIR_PATH>/data/mimic-iii/source/TRANSFERS.csv",
                }
...
def sql_interpreter(command):
    con = sqlite3.connect("<CASCADE_DIR_PATH>/data/mimic-iii/source/mimic_iii.db")
    cur = con.cursor()
