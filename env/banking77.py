"""
This is the environment file for Banking77.
- Financial: user query routing.
[Ref] Efficient intent detection with dual sentence encoders
"""
import json
from .base import Env
from .prompts.banking77_prompt import ZERO_SHOT_PROMPT, CASE_PROMPT, CBR_PROMPT, CASE_PROMPT_REFLEXION

class Banking77Env(Env):
    def __init__(self):
        super().__init__()
        self.dataset = []
        self.init_env()
    ...
    def init_env(self):
        with open("data/banking77/banking77.jsonl", encoding="utf-8") as file:
            for line in file:
